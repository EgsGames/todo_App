...
import nft13 from "../assets/images/nft13.webp";
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.imageCard}>
          <Image style={styles.image} source={nft14} />
        </View>
        <View style={[styles.imageCard, { top: SIZES.medium + 17 }]}>
          <Image style={styles.image} source={nft13} />
        </View>
        <View style={styles.imageCard}>
          <Image style={styles.image} source={nft14} />
        </View>
      ...
      >
        <Text style={styles.mainText}>Find, Add Task Easy </Text>
        <Text style={styles.subText}>
          App help you add Task and Edit Easy 
        </Text>
      </Animated.View>
      <Animated.View
        style={[
